...
### About Me
- 👁️‍🗨️ I'm currently working at Zoega LTD. as FrontEnd Developer with ReactJS, Typescript, API REST, Context, Router, Yup, VideoJS, Webcam, Payment Processors like Paxum, PXP, Stripe or SEPA/SWIFT, graphic stats with ChartJS, Drag and Drop with optimistic asynchronous, Biometrical verification with Veriff, CSS/SASS/Tailwind, Vite, MJML, AWS, Cognito and Lambda, Figma, AGILE with Sprints on JIRA, and Bitbucket, CI/CD workflow. Defining tasks amd coordinating Frontend team and requirements with Backend.
