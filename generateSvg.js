...
async function generateSvg() {
  try {
    ...
    aboutMeLines.forEach((line, index) => {
      ...
      svgContent += `<text x="650" y="${50 + index * 20}" style="font-size: 18px; font-family: monospace;" fill="#00FF00">${updatedLine}</text>`;
    });

    // Generar las estadísticas de GitHub
    svgContent += `
    <text x="650" y="560" fill="#00FF00" style="font-size: 24px; font-family: Arial, sans-serif;">
      ${emoji[0]}
    </text>
    <text x="650" y="470" fill="#00FF00" style="font-size: 18px; font-family: Arial, sans-serif;">
    GitHub Stats:
    </text>
